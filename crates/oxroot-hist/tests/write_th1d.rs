...
use oxroot_hist::{read_th1d, th1d_to_bytes, TH1};
...
fn writes_a_root_file_that_round_trips() {
    ...
    oxroot_hist::write_th1d_file(&out, &h, oxroot_io_core::Compression::None).expect("write file");
...
fn writes_a_zstd_compressed_th1d() {
    ...
    oxroot_hist::write_th1d_file(&out, &h, oxroot_io_core::Compression::Zstd(5))
