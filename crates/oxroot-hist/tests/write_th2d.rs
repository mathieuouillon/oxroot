...
use oxroot_hist::{read_th2d, th2d_to_bytes, TH2};
...
fn create_fill_save_round_trips() {
    ...
    oxroot_hist::write_th2d_file(&out, &h, oxroot_io_core::Compression::None).expect("write");
...
fn writes_a_zstd_compressed_th2d() {
    ...
    oxroot_hist::write_th2d_file(&out, &h, oxroot_io_core::Compression::Zstd(5))
