...
use oxroot_rntuple::{Column, Field, FieldValues, RNTuple};
...
fn writes_a_rich_rntuple_that_round_trips() {
    ...
    oxroot_rntuple::write_rntuple_file(&out, "ntpl", &fields, oxroot_io_core::Compression::None)
...
fn writes_a_zstd_compressed_rntuple_that_round_trips() {
    ...
    oxroot_rntuple::write_rntuple_file(&out, "ntpl", &fields, oxroot_io_core::Compression::Zstd(5))
